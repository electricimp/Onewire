...
The Onewire library provides a means to interact with 1-Wire&reg; devices connected to an imp via UART. For more information on connecting 1-Wire devices this way, see [‘Implementing a 1-Wire Bus on the imp’](https://electricimp.com/docs/resources/onewire/).
...
&nbsp;<br>The code will be one of the following values:
